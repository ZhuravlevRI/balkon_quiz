export function QuizCard(
    ...
    return (
        <div className="card card-sm bg-base-200 border-base-300 rounded-box w-xs border p-4">
            <div className="border-base-300 border-b border-dashed flex items-center justify-between">
                <button className="link link-hover">Test quiz</button>
            ...
            <div className="card-body">
                <p>Quiz about testing and dummy text.</p>
            </div>
        </div>
    )
}
